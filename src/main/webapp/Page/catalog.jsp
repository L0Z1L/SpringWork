...
<div id="center" class="wrapper">
    ...
    <div class="carousel">
        <div class="carousel-imgs">
            <c:forEach var="show" items="${requestScope.show_products}" varStatus="status">
                <c:if test="${status.index<5}" var="show_IF">
                    <div class="carousel-item">
                        <div class="carousel-txt">
                            ...
                            <!--跳转到商品页面 -->
                            <a href="/Products/product?name=${show.product_name}">
                                <span class="glyphicon glyphicon-shopping-cart"></span>
                                Get it now!
                            </a>
                        </div>
                        <img src="../img/fashion/${show.product_category}/${show.img_path}.jpg" alt="">
                    </div>
                </c:if>
            </c:forEach>
    ...
    <div id="main">
        ...
        <!--衣服clothes-->
        <div id="product-list">
            <C:forEach var="productst" items="${products_Books}" varStatus="sta">
                <c:forEach var="product" items="${productst}" varStatus="status">
                    ...
                    <c:if test="${status.count>1}" var="elif">
                        <li>
                            <span class="p-price">$${product.product_price}</span>
                            <a href="/Products/product?name=${product.product_name}" class="product-img" >
                                <img src="../../img/fashion/${product.product_category}/${product.img_path}.jpg" alt="">
